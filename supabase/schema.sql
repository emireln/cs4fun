...
create table if not exists public.leaderboard (
  ...
  board text not null check (board in ('daily', 'duel', 'gauntlet', 'major', 'party', 'box', 'career', 'auction', 'survivor')),
...
create table if not exists public.game_history (
  ...
  nickname text,
  mode text not null check (mode in ('major', 'duel', 'party', 'daily', 'gauntlet', 'box', 'career', 'auction', 'survivor')),
...
create table if not exists public.rooms (
  ...
  status text not null default 'lobby' check (status in ('lobby', 'drafting', 'reveal', 'finished', 'rematch')),
  seed text not null,
...
-- Guest lobby join (no account) — local ids look like p_xxxxxxxx
