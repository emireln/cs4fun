...
import { BookOpen, Calendar, Coffee, Download, Mail, Package, Skull, Star, Swords, Trophy, Users, Zap } from 'lucide-react'
...
const MODE_IDS = ['major', 'duel', 'party', 'box', 'daily', 'career', 'gauntlet', 'survivor']
  ...
  return (
    <div className="carbon-bg min-h-dvh overflow-x-clip">
      ...
      <section className="relative flex min-h-dvh flex-col items-center justify-center overflow-hidden px-5 pb-16 pt-20 text-center">
        ...
        >
          <LogoMark className="h-20 w-auto max-h-20 max-w-[min(100%,16rem)] cursor-pointer sm:h-24 sm:max-h-24 sm:max-w-[18rem]" />
        </motion.div>
